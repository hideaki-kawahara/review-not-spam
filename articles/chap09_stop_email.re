= 迷惑メールを止める
迷惑メールを止めたい、そんな気持ちが起きると思いますが、直接迷惑メールを止める行為は素人は危険な行為であることを認識してください。そして簡単にできることでもなく、リスクもあるので迷惑メールを止めようと思わないでください。

== abuseにメールを送信、サーバー管理者へ連絡
@<b>{知識を持たずに迷惑メールを止めるのは危険な行為です！}@<br>{}
@<b>{生半可な知識で迷惑メール対策を行うことは絶対にやめてください。}@<br>{}

迷惑メールの送信元ドメインから、abuseにメールするという方法で迷惑メールを止める方法があるのですが、ドメインを管理しているところが迷惑メールを送信する業者の可能性もあるので、その場合は迷惑メールが止まるどころか逆に増えます。

国内大手ECサイトなどでは効果があるかもしれませんが、@<b>{基本的にこの方法は使わないください。}

また、迷惑メールの送信元IPアドレスを探して、そのIPアドレスから送信サーバーを探してクレームを入れる方法ですが、サーバーを管理している業者も迷惑メールを送信している業者であることがあるので、@<b>{基本的にこの方法は使わないください。}

それから、送信元ドメインやIPアドレス詐称することは難しくなく、無関係な企業に連絡する可能性もあります。

== スパムハウスに登録

物凄く効果がありますが、上級者向けの方法です。

スパムハウスは迷惑メールを配信しているIPアドレスをデータベースとして記録しているサイトで、迷惑メールフィルターはスパムハウスのデータを参照しているので確実に迷惑メールが止まります。ただ、登録には手続きが少々多く、サイトは全て英文なので上級者向けです。
...
次に対応したいことは、送信元のメールアドレスが携帯電話会社ならば、携帯電話会社に迷惑メールを報告することで迷惑メールを止めることが出来ます。これは非常に効果があるので実践してください。

 1. 迷惑メールの送信元ドメインを確認する。
 2. ドメインが携帯電話会社なら、その携帯電話会社の迷惑メール報告メールアドレスに転送する。
