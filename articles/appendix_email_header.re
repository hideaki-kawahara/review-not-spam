...
メールヘッダーを確認することは、「いつ」「誰か」「どこから」メールがどこから来ていることを認識できるようになります。また迷惑メールを受信しないための色々な取り決めを見ることができます。興味があれば是非ともメールヘッダーをご確認ください。
...
Gmail
ヘッダー全体からメールの経路を確認する @<href>{https://support.google.com/mail/answer/29436?hl=ja}
